...
class CardLastMaintenance extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _buildDetailRowSvg(iconPath: Assets.icons.dollarCoin, text: serviceDetail),
    SizedBox(height: AppSetting.setHeight(12)),
    _buildDetailRowSvg(iconPath: Assets.icons.locationPin, text: location),
    SizedBox(height: AppSetting.setHeight(12)),
    _buildDetailRowSvg(iconPath: Assets.icons.taskList, text: price),
    SizedBox(height: AppSetting.setHeight(24)),
  ...
  children: [
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(AppSetting.setWidth(50)),
          ),
          padding: EdgeInsets.symmetric(vertical: AppSetting.setHeight(14)),
        ),
        child: Text(
          'View Invoice',
          style: TextStyle(
    ...
    Expanded(
      child: OutlinedButton(
        onPressed: () {
          // Aksi untuk tombol Schedule Maintenance
        },
        style: OutlinedButton.styleFrom(
