...
data class BreakdownReportResponse(
    @SerializedName("data")
    val `data`: List<BreakdownReportItemResponse>? = null
)

data class BreakdownReportItemResponse(
    @SerializedName("id")
    val id: Int? = null,
    ...
    val idCheckSheetDetails: Int? = null,
    ...
    @SerializedName("storing")
    val isStoring: Int? = null,
    @SerializedName("storing_reason")
    val storingReason: String? = null
)